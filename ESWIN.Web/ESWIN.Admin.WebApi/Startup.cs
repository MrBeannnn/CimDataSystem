...
using ESWIN.Business.AutoJob;
using ESWIN.Admin.WebApi.Controllers;

namespace ESWIN.Admin.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "ESWIN Api", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("v1/swagger.json", "ESWIN Api v1");
            });
            app.UseRouting();
