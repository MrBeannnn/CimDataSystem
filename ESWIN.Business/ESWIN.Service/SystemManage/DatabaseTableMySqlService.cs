...
namespace ESWIN.Service.SystemManage
{
    public class DatabaseTableMySqlService : RepositoryFactory, IDatabaseTableService
    {
        ...
        /// <summary>
        /// 仅用在ESWINAdmin框架里面，同步不同数据库之间的数据，以 MySql 为主库，同步 MySql 的数据到SqlServer和Oracle，保证各个数据库的数据是一样的
        /// </summary>
        /// <returns></returns>
        ...
        {
            string sqlServerConnectionString = "Server=localhost;Database=ESWINAdmin;User Id=sa;Password=123456;";
