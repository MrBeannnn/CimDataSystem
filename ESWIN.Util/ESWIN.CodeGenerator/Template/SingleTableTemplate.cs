...
using ESWIN.CodeGenerator.Model;
using ESWIN.Util;
using ESWIN.Util.Extension;
using ESWIN.Util.Model;
using ESWIN.Entity.SystemManage;
using ESWIN.Enum.SystemManage;
using ESWIN.Business.Cache;
using ESWIN.Entity;

namespace ESWIN.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "ESWIN.Entity");
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "ESWIN.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "ESWIN.Web", "ESWIN.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using ESWIN.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace ESWIN.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace ESWIN.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using ESWIN.Util;");
            sb.AppendLine("using ESWIN.Util.Extension;");
            sb.AppendLine("using ESWIN.Util.Model;");
            sb.AppendLine("using ESWIN.Data;");
            sb.AppendLine("using ESWIN.Data.Repository;");
            sb.AppendLine("using ESWIN.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ESWIN.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace ESWIN.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using ESWIN.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ESWIN.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ESWIN.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace ESWIN.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using ESWIN.Util;");
            sb.AppendLine("using ESWIN.Util.Model;");
            sb.AppendLine("using ESWIN.Entity;");
            sb.AppendLine("using ESWIN.Model;");
            sb.AppendLine("using ESWIN.Admin.Web.Controllers;");
            sb.AppendLine("using ESWIN.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ESWIN.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ESWIN.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace ESWIN.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "ESWIN.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "ESWIN.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "ESWIN.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "ESWIN.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
